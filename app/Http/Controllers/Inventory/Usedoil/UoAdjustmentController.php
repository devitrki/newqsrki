...
class UoAdjustmentController extends Controller
{
    public function index(Request $request){
        ...
        return view('inventory.usedoil.uo-adjustment', $dataview)->render();
    }
    ...
    public function dtble(Request $request)
    {
        ...
        $query = DB::table('uo_movements')
                    ...
                    ->whereIn('uo_movements.type', [501, 502])
                    ->select(
    ...
    public function store(Request $request)
    {
        ...
        if ($uoMovement->save()) {
            ...
            DB::commit();
            $stat = 'success';
            $msg = Lang::get("message.save.success", ["data" => Lang::get("stock adjustment")]);
        } else {
            DB::rollBack();
            $stat = 'failed';
            $msg = Lang::get("message.save.failed", ["data" => Lang::get("stock adjustment")]);
        }
    ...
    public function cancel(Request $request, $id)
    {
        ...
        if ($uoMovementReverse->save()) {
            ...
            if ($uoMovement->save()) {
                ...
                DB::commit();
                $stat = 'success';
                $msg = Lang::get("message.cancel.success", ["data" => Lang::get("stock adjustment")]);
            } else {
                DB::rollBack();
                $stat = 'failed';
                $msg = Lang::get("message.cancel.failed", ["data" => Lang::get("stock adjustment")]);
            }
        } else {
            DB::rollBack();
            $stat = 'failed';
