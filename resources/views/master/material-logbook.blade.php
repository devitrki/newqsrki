<x-card-scroll>
    <div class="row m-0">
        <div class="col-12 p-0 fit-content-tabs">
            ...
            @endphp
            <x-datatable-serverside :dom="$dom" compid="tabledata" :tabmenu="$menu_id" :columns="$columns" url="master/material-logbook/dtble" :select="[true, 'single']"/>
        </div>
    </div>
</x-card-scroll>

<!-- modal -->
<x-modal :dom="$dom" compid="modalmanage" title="Material Log Book">
    <x-form-horizontal>
...
{{$dom}} = {
    ...
    url: {
        sync: "master/material-logbook/sync",
        save: "master/material-logbook",
    },
    event: {
        create: function () {
            {{$dom}}.func.reset();
