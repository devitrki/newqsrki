        ...
        <div class="col-12 p-0 fit-content-tabs">
            <x-tools>
                <x-slot name="left">
                    ...
                    @can('c'.$menu_id)
                    <x-row-tools class="d-none d-sm-block">
                        <x-button-tools tooltip="List Area" icon="bx bx-collection" :onclick="$dom. '.event.list()'" />
                    </x-row-tools>
                    @endcan
                    <x-row-tools class="d-none d-sm-block">
                    ...
                    <x-row-tools class="d-block d-sm-none">
                        <div class="dropdown d-block d-sm-none">
                            ...
                            <div class="dropdown-menu dropdown-menu-right">
                                ...
                                @endcan
                                @can('c'.$menu_id)
                                <a class="dropdown-item" href="javascript:void(0)" onclick="{{$dom}}.event.list()" ><i class="bx bx-collection mr-50"></i>{{ __('List Area') }}</a>
                                @endcan
            ...
            @endphp
            <x-datatable-serverside :dom="$dom" compid="tabledata" :tabmenu="$menu_id" :columns="$columns" url="master/regional-plant/dtble" :select="[true, 'single']" />
        </div>
    </div>
</x-card-scroll>
...
<x-modal :dom="$dom" compid="modallist" title="List Regional Area">
...
<x-modal :dom="$dom" compid="modalmanagelist" title="List Area">
    <x-form-horizontal>
...
{{$dom}} = {
   data: {
    ...
    url: {
        save: "master/regional-plant",
        list: "master/regional-plant/list/",
    },
    event: {
        create: function () {
            {{$dom}}.func.reset();
