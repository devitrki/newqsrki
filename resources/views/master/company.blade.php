<x-card-scroll>
    <div class="row m-0">
        <div class="col-12 p-0 fit-content-tabs">
            ...
            @endphp
            <x-datatable-serverside :dom="$dom" compid="tabledata" :tabmenu="$menu_id" :columns="$columns" url="master/company/dtble" :select="[true, 'single']" />
        </div>
    </div>
</x-card-scroll>
...
<x-modal :dom="$dom" compid="modalconf" title="Company" size="lg">
    <x-form-horizontal>
        <div class="row">
            <div class="col-12">
...
<x-modal :dom="$dom" compid="modalmanageconf" title="Company Configuration" close="false">
    <x-form-horizontal>
