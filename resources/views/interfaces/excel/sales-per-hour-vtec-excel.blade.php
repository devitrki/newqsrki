...
<table>
    ...
    <tbody>
        ...
        <td>{{ $data['items']['h'.$time]['totalPrice'] }}
        <td>{{ $data['items']['h'.$time]['disc'] }}
        <td>{{ $data['items']['h'.$time]['subTotal'] }}
        <td>0</td>
        <td>{{ $data['items']['h'.$time]['subTotal'] }}
        <td>{{ $data['items']['h'.$time]['tax'] }}
        <td>{{  round(abs($data['items']['h'.$time]['totalPayment'] - ($data['items']['h'.$time]['subTotal'] + $data['items']['h'.$time]['tax']))) }}
        <td>{{ $data['items']['h'.$time]['netSales'] }}
        <td>{{ $data['items']['h'.$time]['totalPayment'] }}
        @else
        <td>0</td>
        <td>0</td>
        <td>0</td>
