                            ...
                            <div class="col-12">
                                <x-form-vertical>
                                    <x-row-vertical label="Plant">
                                        <x-select :dom="$dom" compid="fplant" type="serverside" url="master/plant/select?auth=true&ext=all" size="sm" :default="[0, __('All') ]"/>
                                    </x-row-vertical>
...
{{$dom}} = {
   data: {
    ...
    url: {
        report: "report/financeacc/log-mutation-asset/report",
        export: "report/financeacc/log-mutation-asset/export",
    },
    event: {
        excel: function () {
