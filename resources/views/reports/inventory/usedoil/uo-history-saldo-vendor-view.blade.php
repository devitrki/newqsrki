                            ...
                            <div class="col-12">
                                <x-form-vertical>
                                    <x-row-vertical label="Vendor">
                                        <x-select :dom="$dom" compid="fvendor" type="serverside" url="inventory/usedoil/uo-vendor/select" size="sm" dropdowncompid="tabledata" :default="[$first_vendor_id, $first_vendor_name]"/>
                                    </x-row-vertical>
...
<x-modal :dom="$dom" compid="modalexport" title="Export Report">
    <x-form-horizontal>
        ...
        <x-row-horizontal label="Vendor">
            <x-select :dom="$dom" compid="evendor" type="serverside" url="inventory/usedoil/uo-vendor/select?ext=all" size="sm"/>
        </x-row-horizontal>
...
{{$dom}} = {
   data: {
    ...
    url: {
        report: "report/inventory/uo-history-saldo-vendor/report",
        export: "report/inventory/uo-history-saldo-vendor/export",
    },
    event: {
        excel: function () {
    ...
    func: {
        show: function () {
            ...
            var url ={{$dom}}.url.report + '?vendor-id=' + fslctfvendor{{$dom}}.get() + '&from-date=' + pickerdateffromdate{{$dom}}.get('select', 'yyyy/mm/dd') + '&until-date=' + pickerdatefuntildate{{$dom}}.get('select', 'yyyy/mm/dd');
