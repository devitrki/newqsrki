...
{{$dom}} = {
   data: {
    ...
    url: {
        report: "report/inventory/uo-income-sales-summary/report",
        export: "report/inventory/uo-income-sales-summary/export",
    },
    event: {
        excel: function () {
    ...
    func: {
        show: function () {
            ...
            var url ={{$dom}}.url.report + '?from-date=' + pickerdateffromdate{{$dom}}.get('select', 'yyyy/mm/dd') + '&until-date=' + pickerdatefuntildate{{$dom}}.get('select', 'yyyy/mm/dd');
