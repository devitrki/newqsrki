...
<x-modal :dom="$dom" compid="modalexport" title="Export Report">
    <x-form-horizontal>
        ...
        <x-row-horizontal label="Plant">
            <x-select :dom="$dom" compid="eplant" type="serverside" url="master/plant/select?auth=true&ext=all" size="sm"/>
        </x-row-horizontal>
...
{{$dom}} = {
   data: {
    ...
    url: {
        report: "report/inventory/uo-income-sales-detail/report",
        export: "report/inventory/uo-income-sales-detail/export",
    },
    event: {
        excel: function () {
