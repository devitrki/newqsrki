...
{{$dom}} = {
   data: {
    ...
    url: {
        report: "report/inventory/gr-vendor/report",
        export: "report/inventory/gr-vendor/export",
    },
    event: {
        excel: function () {
    ...
    func: {
        show: function () {
            ...
            var url ={{$dom}}.url.report + '?plant-id=' + $("#select2fplant{{$dom}}").val() + '&from-date=' + pickerdateffromdate{{$dom}}.get('select', 'yyyy/mm/dd') + '&until-date=' + pickerdatefuntildate{{$dom}}.get('select', 'yyyy/mm/dd');
