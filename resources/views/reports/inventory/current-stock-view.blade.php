                        ...
                        <x-dropdown-filter :dom="$dom" dtblecompid="tabledata">
                            <div class="col-12">
                                <x-form-vertical>
                                    ...
                                    <x-row-vertical label="Material Type">
                                        @php
                                            $options = [
                                                        ['id' => 'all', 'text' => __('All')],
                                                        ['id' => 'ZROH', 'text' => 'Raw Material Product RKI - ZROH'],
                                                        ['id' => 'ZHAL', 'text' => 'Semi Finished Product RKI - ZHAL'],
                                                        ['id' => 'ZFER', 'text' => 'Finished Product RKI - ZFER'],
                                                        ['id' => 'ZPRP', 'text' => 'Principal Product (Snack) - ZPRP'],
                                                        ['id' => 'ZVER', 'text' => 'Packaging RKI - ZVER'],
                                                        ['id' => 'ZHIB', 'text' => 'Operating Supplies - ZHIB'],
                                                    ];
                                        @endphp
                                        <x-select :dom="$dom" compid="fmaterial_type" type="array" :options="$options" size="sm"/>
                                    </x-row-vertical>
                                </x-form-vertical>
                            </div>
...
<x-modal :dom="$dom" compid="modalexport" title="Export Report">
    <x-form-horizontal>
        ...
        <x-row-horizontal label="Material Type">
            @php
                $options = [
                            ['id' => 'all', 'text' => __('All')],
                            ['id' => 'ZROH', 'text' => 'Raw Material Product RKI - ZROH'],
            ...
            @endphp
            <x-select :dom="$dom" compid="ematerial_type" type="array" :options="$options" size="sm"/>
        </x-row-horizontal>
    </x-form-horizontal>
...
{{$dom}} = {
   data: {
    ...
    url: {
        report: "report/inventory/current-stock/report",
        export: "report/inventory/current-stock/export",
    },
    event: {
        excel: function () {
    ...
    func: {
        show: function () {
            ...
            var url ={{$dom}}.url.report + '?plant-id=' + fslctfplant{{$dom}}.get() + '&material-type=' + fslctfmaterial_type{{$dom}}.get();
        ...
        getDataForm: function () {
            return {
                ...
                'material_type': fslctematerial_type{{$dom}}.get(),
