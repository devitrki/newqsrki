                            ...
                            <div class="col-12">
                                <x-form-vertical>
                                    <x-row-vertical label="Plant">
                                        <x-select :dom="$dom" compid="fplant" type="serverside" url="master/plant/select?type=outlet" size="sm"/>
                                    </x-row-vertical>
                                    ...
                                    <x-row-vertical label="Status">
                                        <select class="form-control form-control-sm" id="fstatus{{$dom}}">
...
<x-modal :dom="$dom" compid="modalexport" title="Export Report">
    <x-form-horizontal>
        ...
        <x-row-horizontal label="Plant">
            <x-select :dom="$dom" compid="eplant" type="serverside" url="master/plant/select?type=outlet" size="sm"/>
        </x-row-horizontal>
        ...
        <x-row-horizontal label="Status">
            <select class="form-control form-control-sm" id="estatus{{$dom}}">
                <option value="2">All</option>
                <option value="1">Success</option>
                <option value="0">Failed</option>
            </select>
...
{{$dom}} = {
   data: {
    ...
    url: {
        report: "report/external-vendor/history-send-vendor/report",
        export: "report/external-vendor/history-send-vendor/export",
    },
    event: {
        excel: function () {
