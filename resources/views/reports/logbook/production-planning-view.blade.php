...
<x-modal :dom="$dom" compid="modalexport" title="Export Report">
    <x-form-horizontal>
        ...
        <x-row-horizontal label="Product">
            <x-select :dom="$dom" compid="eproduct" type="serverside" url="logbook/mapping/product-production-planning/select" size="sm" :default="[$first_product, $first_product]"/>
        </x-row-horizontal>
...
{{$dom}} = {
   data: {
    ...
    url: {
        report: "report/logbook/production-planning/report",
        export: "report/logbook/production-planning/export",
    },
    event: {
        excel: function () {
