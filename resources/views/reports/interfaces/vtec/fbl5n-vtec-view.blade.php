                            ...
                            <div class="col-12">
                                <x-form-vertical>
                                    <x-row-vertical label="Store">
                                        <x-select :dom="$dom" compid="fstore" type="serverside" url="master/plant/select?type=outlet&auth=true&pos=vtec&ext=all" size="sm" :default="[0, __('All')]"/>
                                    </x-row-vertical>
...
<x-modal :dom="$dom" compid="modalexport" title="Export Report">
    <x-form-horizontal>
        ...
        <x-row-horizontal label="Store">
            <x-select :dom="$dom" compid="estore" type="serverside" url="master/plant/select?type=outlet&auth=true&ext=all" size="sm" :default="[0, __('All')]"/>
        </x-row-horizontal>
...
{{$dom}} = {
   data: {
    ...
    url: {
        report: "report/interfaces/fbl5n-vtec/report",
        export: "report/interfaces/fbl5n-vtec/export",
    },
    event: {
        excel: function () {
