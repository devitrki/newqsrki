                            ...
                            <div class="col-12">
                                <x-form-vertical>
                                    <x-row-vertical label="Store">
                                        <x-select :dom="$dom" compid="fstore" type="serverside" url="master/plant/select?type=outlet&auth=true&pos=vtec" size="sm"/>
                                    </x-row-vertical>
...
<x-modal :dom="$dom" compid="modalexport" title="Export Report">
    <x-form-horizontal>
        ...
        <x-row-horizontal label="Store">
            <x-select :dom="$dom" compid="estore" type="serverside" url="master/plant/select?type=outlet&auth=true&pos=vtec" size="sm"/>
        </x-row-horizontal>
...
{{$dom}} = {
   data: {
    ...
    url: {
        report: "report/interfaces/summary-payment-promotion-vtec/report",
        export: "report/interfaces/summary-payment-promotion-vtec/export",
    },
    event: {
        excel: function () {
