                            ...
                            <div class="col-12">
                                <x-form-vertical>
                                    <x-row-vertical label="Date">
                                        <x-pickerdate :dom="$dom" compid="fdate" data-value="{{ date('Y/m/d', strtotime('-1 days')) }}" clear="false"/>
                                    </x-row-vertical>
                                </x-form-vertical>
                            </div>
...
{{$dom}} = {
   data: {
    ...
    url: {
        report: "report/interfaces/store-not-yet-send-vtec/report",
        export: "report/interfaces/store-not-yet-send-vtec/export",
    },
    event: {
        excel: function () {
    ...
    func: {
        show: function () {
            ...
            var url ={{$dom}}.url.report + '?date=' + pickerdatefdate{{$dom}}.get('select', 'yyyy/mm/dd');
